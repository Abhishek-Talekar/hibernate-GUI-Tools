...
// Generated Feb 17, 2020 3:40:52 PM by Hibernate Tools 4.3.5.Final
...
public class CustomerHome {
	...
	public Customer findById(java.lang.String id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("com.ht.entities.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.ht.entities.Customer")
